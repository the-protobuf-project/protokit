...
// and an optional one nulls out. An explicit on_delete from the generator's
// column option (Backend.ReadColumn) wins.
...
func ensurePK(t *schema.Table) {
	...
	id := &schema.Column{
		...
		PrimaryKey: true, NotNull: true, Type: schema.TypeULID, Generated: "ulid",
	}
